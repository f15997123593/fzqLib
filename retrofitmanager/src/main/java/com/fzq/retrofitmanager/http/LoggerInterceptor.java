...
public class LoggerInterceptor implements Interceptor {
    ...
    private void logForRequest(Request request) {
        try {
            ...
            Log.d("LoggerInterceptor","method : " + request.method() + "  ║  url : " + url);
            ...
            if (requestBody != null) {
                ...
                if (mediaType != null) {
                    ...
                    if (isText(mediaType)) {
                        Log.d("LoggerInterceptor","requestBody's content : " + bodyToString(request));
                    } else {
...
//            e.printStackTrace();
    ...
    private Response logForResponse(Response response) {
        try {
            ...
            Log.d("LoggerInterceptor","url : " + clone.request().url() + "  ║  code : " + clone.code() + "  ║  protocol : " + clone.protocol());
                    ...
                    if (body != null) {
                        ...
                        if (mediaType != null) {
                            ...
                            if (isText(mediaType)) {
                                ...
                                Log.d("LoggerInterceptor","responseBody's content : " + " maybe [file part] , too large too print , ignored!");
                            }
                        }
                    }
                }
