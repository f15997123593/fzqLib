package com.fzq.utillib.pickview;
...
//        使用方法
//        CustomDatePicker starttimePicker = new CustomDatePicker(this, "选择时间", new CustomDatePicker.ResultHandler() {
//                @Override
//            public void handle(String time) {
//                starttimeTv.setText(time);
//                startSearchData();
//            }
//        }, "2000-01-01 00:00", "2030-12-31 23:59");//"2027-12-31 23:59"
//        starttimePicker.showSpecificTime(true); //设置日期控件是否显示时和分
//        starttimePicker.setIsLoop(true); //设置循环滚动
//        starttimePicker.show(starttimeTv.getText().toString()); //显示

/**
 * 自定义日期时间选择器
 * yyyy-MM-dd HH:mm
 * Created by fzq on 2016/9/28.
 */
