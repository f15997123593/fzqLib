package com.fzq.utillib.toastutil;
...
public class StyleableToast extends LinearLayout {
    ...
    public static StyleableToast makeText(@NonNull Context context, String text) {
        return new StyleableToast(context, text, Toast.LENGTH_SHORT, R.style.ColoredBackground);
    }
