...
import com.fzq.cameralib.listener.CaptureListener;
import com.fzq.cameralib.util.CheckPermission;
import com.fzq.cameralib.util.LogUtil;

import static com.fzq.cameralib.JCameraView.BUTTON_STATE_BOTH;
import static com.fzq.cameralib.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.fzq.cameralib.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    public CaptureButton(Context context, int size) {
        ...
        min_duration = 800;              //默认最短录制时间为0.8s
